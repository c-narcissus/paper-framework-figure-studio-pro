...
<p align="center">
  <img src="v3.2.15b/architecture-v3.2.15b-zh.png" alt="论文框架图工作室 Skill 流程架构 v3.2.15b" width="860">
</p>

**重要提示：1，`v3.2.15b/` 目录里有 v3.2.15b 使用介绍视频；2，非 Codex 用户、非计算机专业用户如果想改这个 skill，请直接看中文部分最后的指南。**
...
| --------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- |
| <img src="v3.2.15b/example_semiDFL_v3.2.15b/R2_results_chatgpt_web_v3.2.15b/F06.png" alt="v3.2.15b F06" width="390"> | <img src="v3.2.15/R2_results_chatgpt_web_v3.2.15/F03.png" alt="v3.2.15 F03" width="390"> |
...
- v3.2.15b skill 包：`v3.2.15b/paper-framework-figure-studio-pro-v3.2.15b-skill.zip`。
...
<p align="center">
  <img src="v3.2.15b/生图Prompt框架图描述方案_v3.2.15b_zh.png" alt="生图 Prompt 里的框架图描述方案" width="860">
</p>
...
<p align="center">
  <img src="v3.2.15b/生图Prompt审计前移流程_v3.2.15b_zh.png" alt="生图 Prompt 审计前移流程" width="860">
</p>
...
<p align="center">
  <img src="v3.2.15b/生图Prompt结构化模板示例_v3.2.15b_zh.png" alt="生图 Prompt 结构化模板示例" width="860">
</p>
...
- v3.2.15b 资料目录：`v3.2.15b/`
- v3.2.15b skill 包：`v3.2.15b/paper-framework-figure-studio-pro-v3.2.15b-skill.zip`
- v3.2.15b 使用介绍视频：`v3.2.15b/chatgpt-web-usage-v3.2.15b.mp4` 和 `v3.2.15b/codex-usage-v3.2.15b.mp4`
- v3.2.15b 示例结果：`v3.2.15b/example_semiDFL_v3.2.15b/`
- v3.2.15b ChatGPT 网页端 S0-S3 沟通记录截图：`v3.2.15b/example_semiDFL_v3.2.15b/S0-S3_chatgpt_web_v3.2.15b.png`
- v3.2.15b ChatGPT 网页端 S4-S5 沟通记录截图：`v3.2.15b/example_semiDFL_v3.2.15b/S4-S5_chatgpt_web_v3.2.15b.png`
- v3.2.15b 第一轮候选：`v3.2.15b/example_semiDFL_v3.2.15b/R1_results_chatgpt_web_v3.2.15b/`，`C01.png` 到 `C08.png`
- v3.2.15b 第二轮候选：`v3.2.15b/example_semiDFL_v3.2.15b/R2_results_chatgpt_web_v3.2.15b/`，`F01.png` 到 `F06.png`
...
ChatGPT 网页版使用时，先把 skill zip 和目标论文 PDF 放进项目 Sources；如需要，可使用 `v3.2.15b/example_semiDFL_v3.2.15b/semiDFL.pdf`。在需要图像生成的阶段，手动切换到 `Create image`。

Codex 使用时，把 skill zip 和目标论文 PDF 放在当前工程目录中，或在 prompt 中写清楚相对路径。

`v3.2.15b/` 目录提供两个 v3.2.15b 使用介绍视频：`v3.2.15b/chatgpt-web-usage-v3.2.15b.mp4` 和 `v3.2.15b/codex-usage-v3.2.15b.mp4`。
...
```text
请严格按照v3.2.15b/paper-framework-figure-studio-pro-v3.2.15b-skill.zip 里 skill 的人机交互步骤，对v3.2.15b/example_semiDFL_v3.2.15b/semiDFL.pdf 绘制 diagram。不要查看semiDFL.pdf 里面已有的diagram；这里的“不要查看”不是说不能自己构思出类似图，而是不要被原图先入为主，应根据论文实际内容决定生成或不生成类似结构。
```

中断后继续时，可以只要求下一步建议。ChatGPT 网页端示例：

```text
刚才中断了， 请使用 sources/paper-framework-figure-studio-pro-v3.2.15b-skill.zip 里的 skill 根据当前状态（见stage-S3.zip),只建议下一步提示词，不要自动执行下一步
```
...
本节只展示当前目录中实际存在的 **v3.2.15b** 结果。示例论文为 `v3.2.15b/example_semiDFL_v3.2.15b/semiDFL.pdf`。第一轮是全局探索候选 `C01-C08`，第二轮是正式候选 `F01-F06`，均来自 ChatGPT 网页环境。

### 第一轮候选图（R1, v3.2.15b）

| C01 | C02 | C03 | C04 |
| --- | --- | --- | --- |
| <img src="v3.2.15b/example_semiDFL_v3.2.15b/R1_results_chatgpt_web_v3.2.15b/C01.png" alt="R1 C01" width="190"> | <img src="v3.2.15b/example_semiDFL_v3.2.15b/R1_results_chatgpt_web_v3.2.15b/C02.png" alt="R1 C02" width="190"> | <img src="v3.2.15b/example_semiDFL_v3.2.15b/R1_results_chatgpt_web_v3.2.15b/C03.png" alt="R1 C03" width="190"> | <img src="v3.2.15b/example_semiDFL_v3.2.15b/R1_results_chatgpt_web_v3.2.15b/C04.png" alt="R1 C04" width="190"> |
| C05 | C06 | C07 | C08 |
| <img src="v3.2.15b/example_semiDFL_v3.2.15b/R1_results_chatgpt_web_v3.2.15b/C05.png" alt="R1 C05" width="190"> | <img src="v3.2.15b/example_semiDFL_v3.2.15b/R1_results_chatgpt_web_v3.2.15b/C06.png" alt="R1 C06" width="190"> | <img src="v3.2.15b/example_semiDFL_v3.2.15b/R1_results_chatgpt_web_v3.2.15b/C07.png" alt="R1 C07" width="190"> | <img src="v3.2.15b/example_semiDFL_v3.2.15b/R1_results_chatgpt_web_v3.2.15b/C08.png" alt="R1 C08" width="190"> |

### 第二轮候选图（R2, v3.2.15b）

| F01 | F02 | F03 |
| --- | --- | --- |
| <img src="v3.2.15b/example_semiDFL_v3.2.15b/R2_results_chatgpt_web_v3.2.15b/F01.png" alt="R2 F01" width="250"> | <img src="v3.2.15b/example_semiDFL_v3.2.15b/R2_results_chatgpt_web_v3.2.15b/F02.png" alt="R2 F02" width="250"> | <img src="v3.2.15b/example_semiDFL_v3.2.15b/R2_results_chatgpt_web_v3.2.15b/F03.png" alt="R2 F03" width="250"> |
| F04 | F05 | F06 |
| <img src="v3.2.15b/example_semiDFL_v3.2.15b/R2_results_chatgpt_web_v3.2.15b/F04.png" alt="R2 F04" width="250"> | <img src="v3.2.15b/example_semiDFL_v3.2.15b/R2_results_chatgpt_web_v3.2.15b/F05.png" alt="R2 F05" width="250"> | <img src="v3.2.15b/example_semiDFL_v3.2.15b/R2_results_chatgpt_web_v3.2.15b/F06.png" alt="R2 F06" width="250"> |
...
<p align="center">
  <img src="v3.2.15b/paper-figure-studio-skill-workflow-architecture_v3.2.15b_en.png" alt="Paper Figure Studio Skill workflow architecture v3.2.15b" width="860">
</p>

**Important: 1. The `v3.2.15b/` directory includes v3.2.15b usage walkthrough videos. 2. If you are not using Codex, or if you are outside computer science and want to adapt this skill, see the guide at the end of the English section.**
...
- v3.2.15b skill package: `v3.2.15b/paper-framework-figure-studio-pro-v3.2.15b-skill.zip`.
...
<p align="center">
  <img src="v3.2.15b/architecture-v32.15b-en.png" alt="Framework diagram description scheme inside an image-generation prompt" width="860">
</p>
...
<p align="center">
  <img src="v3.2.15b/image-generation-prompt-audit-first-workflow_v3.2.15b_en.png" alt="Prompt-audit-forward image-generation workflow" width="860">
</p>
...
<p align="center">
  <img src="v3.2.15b/structured-prompt-template-example_v3.2.15b_en.png" alt="Structured prompt template example" width="860">
</p>
...
- v3.2.15b materials directory: `v3.2.15b/`
- v3.2.15b skill package: `v3.2.15b/paper-framework-figure-studio-pro-v3.2.15b-skill.zip`
- v3.2.15b usage walkthrough videos: `v3.2.15b/chatgpt-web-usage-v3.2.15b.mp4` and `v3.2.15b/codex-usage-v3.2.15b.mp4`
- v3.2.15b example results: `v3.2.15b/example_semiDFL_v3.2.15b/`
- v3.2.15b ChatGPT web S0-S3 conversation screenshot: `v3.2.15b/example_semiDFL_v3.2.15b/S0-S3_chatgpt_web_v3.2.15b.png`
- v3.2.15b ChatGPT web S4-S5 conversation screenshot: `v3.2.15b/example_semiDFL_v3.2.15b/S4-S5_chatgpt_web_v3.2.15b.png`
- v3.2.15b first-round candidates: `v3.2.15b/example_semiDFL_v3.2.15b/R1_results_chatgpt_web_v3.2.15b/`, `C01.png` to `C08.png`
- v3.2.15b second-round candidates: `v3.2.15b/example_semiDFL_v3.2.15b/R2_results_chatgpt_web_v3.2.15b/`, `F01.png` to `F06.png`
...
In ChatGPT Web, add the skill zip and the target paper PDF to the project Sources. If needed, use `v3.2.15b/example_semiDFL_v3.2.15b/semiDFL.pdf`. When the workflow reaches an image-generation stage, manually switch to `Create image`.
...
The `v3.2.15b/` directory includes two v3.2.15b walkthrough videos: `v3.2.15b/chatgpt-web-usage-v3.2.15b.mp4` and `v3.2.15b/codex-usage-v3.2.15b.mp4`.
...
```text
Please strictly follow the human-in-the-loop workflow steps in v3.2.15b/paper-framework-figure-studio-pro-v3.2.15b-skill.zip to draw a diagram for v3.2.15b/example_semiDFL_v3.2.15b/semiDFL.pdf. Do not look at the existing diagram inside semiDFL.pdf. Here, "do not look" does not mean you cannot independently design a similar figure; it means you should not be anchored by the original figure, and should decide from the actual paper content whether to generate a similar structure or not.
```

When continuing after an interruption, ask only for the next suggested prompt. ChatGPT Web example:

```text
The previous run was interrupted. Please use the skill in sources/paper-framework-figure-studio-pro-v3.2.15b-skill.zip and the current state (see stage-S3.zip) to suggest only the next prompt. Do not automatically execute the next step.
```
...
This section shows only the **v3.2.15b** outputs that currently exist in this directory. The example paper is `v3.2.15b/example_semiDFL_v3.2.15b/semiDFL.pdf`. Round 1 contains global-exploration candidates `C01-C08`; Round 2 contains formal candidates `F01-F06`; both were produced in the ChatGPT web environment.
